...
def find_afterparties():
    ...
    if location and distance and measurement:
        ...
        payload = {
            ...
            'location_within': distance,
            'sort_by': sort
        }
        data = requests.get('https://eventbriteapi.com/v3/events/search', params=payload)
        events = []
...
def create_eventbrite_event():
    ...
    response = requests.post('https://eventbriteapi.com/v3/organizations//events', data=payload)
